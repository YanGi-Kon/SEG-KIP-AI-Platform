...
(function setupAppLoginUi(){
  ...
  function injectStyle(){
    ...
    style.textContent = `
      ...
      .seg-entry-login-brand{display:flex;align-items:center;gap:16px;margin-bottom:30px;}.seg-entry-login-logo{width:62px;height:62px;flex:0 0 62px;display:grid;place-items:center;overflow:hidden;}.seg-entry-login-logo::before{content:'';width:100%;height:100%;background:url('/assets/images/saneg-favicon.png?v=saneg4') center/contain no-repeat;}
