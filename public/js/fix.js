...
(function injectActsWorkspaceModules(){
  ...
  function inject(frame){
    try {
      ...
      appendScript(doc, 'segActsWorkspaceSignersScript', '/js/acts-workspace-signers.js?v=stage7f-signer-select');
      appendScript(doc, 'segActsWorkspaceDocumentsScript', '/js/acts-workspace-documents.js?v=stage8h');
    } catch (_) {}
  }
  function bind(){
    if (isSanegLoginActive()) return;
