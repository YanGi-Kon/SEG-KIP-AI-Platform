...
router.post('/select', async (req, res) => {
  try {
    ...
    // Do not short-circuit explicit period changes with a server response cache.
    // The visible HISOBOT period must stay synchronized with База!O1/Q1.
    // Returning a cached August response after September was selected would leave
    // Sheets on September while the UI shows August.
