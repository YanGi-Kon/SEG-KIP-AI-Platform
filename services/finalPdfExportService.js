...
function wrapHtmlForPdf(html, actNo) {
  ...
  return `<!doctype html><html lang="uz"><head><meta charset="utf-8"><title>${safeFilePart(actNo, 'ACT')}</title><style>body{margin:0;padding:0;background:#ffffff;color:#111827;font-family:Arial,sans-serif}.pdf-wrap{padding:18px}.paper{background:#ffffff}.a4-preview{max-width:210mm;min-height:297mm;margin:0 auto;background:#fff;color:#111;padding:18mm;box-sizing:border-box;font-family:"Times New Roman",serif}.act-signers-value{position:relative}.act-signers-value.has-signature{min-height:62px}.act-signature-box{position:absolute;left:50%;bottom:-1px;transform:translateX(-50%);width:140px;height:58px;display:flex;align-items:flex-end;justify-content:center;overflow:hidden;box-sizing:border-box}.act-signature-box img{display:block;width:100%;height:100%;object-fit:contain;object-position:center bottom}.act-final-signatures{margin-top:18px;break-inside:avoid;page-break-inside:avoid}.act-final-signatures-title{font-size:16px;font-weight:700;margin-bottom:8px}.act-final-signatures-grid{display:grid;gap:12px}.act-final-signature-row{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:16px;align-items:end}.act-final-signature-cell{text-align:center;min-width:0}.act-final-signature-value{position:relative;min-height:58px;padding:0 4px 2px;border-bottom:1px solid #111;display:flex;align-items:flex-end;justify-content:center;box-sizing:border-box;word-break:break-word}.act-final-signature-label{font-size:12px;line-height:1.15;margin-top:2px}img{max-width:100%;height:auto;display:inline-block}</style></head><body><div class="pdf-wrap">${body}</div></body></html>`;
}
